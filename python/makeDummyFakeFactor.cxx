void makeDummyFakeFactor() {
    ...
    //TH2D h_mu("FakeFactor_mu_pt_eta","", nbins, xmin, xmax, nbinsy, ymax, ymin);
    TH2D h_mu_syst("FakeFactor_mu_pt_eta__Syst","", nbins, xmin, xmax, nbinsy, ymax, ymin);
    //TH2D h_el("FakeFactor_el_pt_eta","", nbins, xmin, xmax, nbinsy, ymax, ymin);
    TH2D h_el_syst("FakeFactor_el_pt_eta__Syst","", nbins, xmin, xmax, nbinsy, ymax, ymin);
    // Set histograms
